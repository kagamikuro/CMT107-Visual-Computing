...
public class CG01 extends JFrame implements GLEventListener {
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        float[] vertexArray = { 0.0f, 0.0f,0.5f,0.6f,0.3f,-0.7f,-0.7f,0.3f };
...
//	    gl.glLineWidth(5);
        ...
        gl.glDrawArrays(GL_LINE_STRIP, 0, numVertices);
    }
